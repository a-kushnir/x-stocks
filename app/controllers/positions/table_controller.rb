  ...
  class TableController < ApplicationController
    ...
    def table
      ...
      table.init_columns do |columns|
        ...
        columns << DataTable::Column.new(code: 'trc', label: t('positions.columns.total_return'), formatter: 'currency_delta', sorting: 'positions.gain_loss', default: true)
        columns << DataTable::Column.new(code: 'trp', label: t('positions.columns.total_return_pct'), formatter: 'percent_delta2', sorting: 'positions.gain_loss_pct', default: true)
        ...
        columns << DataTable::Column.new(code: 'exd', label: t('positions.columns.ex_dividend_date'), formatter: 'future_date', sorting: 'stocks.next_div_ex_date')
      end
    end
