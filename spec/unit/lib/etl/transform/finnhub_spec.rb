...
describe Etl::Transform::Finnhub do
  subject(:transformer) { described_class.new(exchange_class: exchange_class, stock_ar_class: stock_ar_class) }
  ...
  describe '#company' do
    ...
    it 'saves data into model' do
      ...
      calls = {
        ...
        sector: 'Technology',
        store_logo: ['https://static.finnhub.io/logo/url_to_a_logo.png'],
        save: []
      }
